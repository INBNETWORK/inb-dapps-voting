        ...
        <div>
          <div className="left">
            <div className="form-el">
              ...
              />
              <p className="hint">
                Voting key address of new validator.<br />Example: 0xc70760D...C51Ee.
              </p>
            </div>
          </div>
          <div className="right">
            <div className="form-el">
              ...
              />
              <p className="hint">
                Payout key address of new validator.<br />Example: 0xc70760D...C51Ee.
              </p>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="right">
            <div className="form-el">
              ...
              />
              <p className="hint">
                Mining key address of validator to vote for.<br />Example: 0xc70760D...C51Ee.
              </p>
            </div>
          </div>
